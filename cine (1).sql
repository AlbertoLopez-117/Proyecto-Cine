...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-01-2021 a las 19:43:52
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `RegistrarCleinte` (`nom_per` VARCHAR(45), `apepa_per` VARCHAR(45), `apema_per` VARCHAR(45), `correo_per` VARCHAR(45), `dierccion_per` TEXT(60), `fechaNac_per` DATE, `phone_per` VARCHAR(11), `correo` VARCHAR(50), `pass` VARCHAR(50))  begin
...
--
ALTER TABLE `peliculas`
  MODIFY `id_pelis` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuario`
  MODIFY `usu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
